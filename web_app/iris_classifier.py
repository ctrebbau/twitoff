...
MODEL_FILEPATH = os.path.join(basedir, "models", "latest_model.pkl")
...
def train_and_save_model():
    ...
    try:
        with open(MODEL_FILEPATH, mode="wb") as model_file:
            pickle.dump(classifier, model_file)
    except:
        with open(MODEL_FILEPATH, mode="x") as model_file:
            pickle.dump(classifier, model_file)
    return classifier
